...
const SIdeIconBar = () => {
  return (
    <div className='hidden fixed top-1/2 transform -translate-y-1/2 z-50 md:flex flex-col items-center left-20 gap-10 font-bold text-customBlue transition-all ease-out duration-300'>
