                ...
                TestimonialDATA.map((items)=>(
                    <SwiperSlide key={items.id}>
                        <div className='relative h-full'>
                            <Image className='absolute bottom-0 left-0 z-[-1]' src={testimonialBG} alt='testimonial nature background'/>
                            <div className='flex gap-32 z-30 w-4/5 h-full mx-auto justify-center'>
                                <div className='w-1/2 h-full flex flex-col justify-center'>
                                    <h6 className='text-customBlue-dark font-medium text-base'>Words From</h6>
                                    <h3 className='text-4xl text-customBlue-dark font-bold'>Happy Clients</h3>
                                    <p className='text-customDark italic text-lg py-4'>{items.review}</p>
